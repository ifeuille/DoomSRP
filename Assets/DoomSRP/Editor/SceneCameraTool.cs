...
//    [MenuItem("Tools/SceneView/SceneView Cam Tool")]
//    static void Init()
//    {
...
//        instance = window;
//    }
//    [MenuItem("Tools/SceneView/Reset SceneView Shaders")]
...
//        //UnityEditor.SceneView.onSceneGUIDelegate -= OnPreSceneGUI;
//        //UnityEditor.SceneView.onSceneGUIDelegate/*beforeSceneGui*/+= OnPreSceneGUI;
//    }
...
//        Camera[] cs = SceneView.GetAllSceneCameras();
//        Camera[] ac = Camera.allCameras;
//        if (resetFovOnce)
//            resetFovOnce = false;
//        else
