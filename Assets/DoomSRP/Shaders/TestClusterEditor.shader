Shader "DoomSRP/TestCluster_Editor"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
		//[HideInInspector] _IFScreenSize_EDITOR ("ScreenSize",Vector) = (0,0,0,0)
		//[HideInInspector] NUM_CLUSTERS_X_EDITOR ("NUM_CLUSTERS_X",Int) = 0
		//[HideInInspector] NUM_CLUSTERS_Y_EDITOR ("NUM_CLUSTERS_Y",Int) = 0
		//[HideInInspector] NUM_CLUSTERS_Z_EDITOR ("NUM_CLUSTERS_Z",Int) = 0
		//[HideInInspector] MAX_ITEMS_PERCUSTER_EDITOR ("MAX_ITEMS_PERCUSTER",Int) = 0
		//[HideInInspector] _ClusterLighting_EDITOR ("_ClusterLighting", Vector) = (0, 0, 0, 0)
		//[HideInInspector] _ClusterCB_Size_EDITOR ("_ClusterCB_Size", Vector) = (0, 0, 0, 0)
    }
	HLSLINCLUDE

	#include "UnityCG.cginc"
#define CLUSTER_EDITOR
