...
namespace DoomSRP
{
    ...
    static public class Math
    {
        ...
        static public bool IsColorChar(char ch)
        {
            switch (ch)
            {
                case '0': return true;
        ...
        static public float DistanceToRectangle(Vector2[] screenPoints, Vector2 mousePos)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                Vector3 v0 = screenPoints[Math.RepeatIndex(i, 4)];
                Vector3 v1 = screenPoints[Math.RepeatIndex(j, 4)];
            ...
            if (!oddNodes)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    Vector3 v1 = screenPoints[Math.RepeatIndex(i + 1, 4)];
